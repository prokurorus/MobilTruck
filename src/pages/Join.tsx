    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-10">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-semibold mb-2">{joinPageTitle[language]}</h1>
        ...
        <div className="border rounded-xl p-4 shadow-sm">
          ...
          <p className="text-sm text-gray-600 mb-2">{alreadyHereSubtitle[language]}</p>
        ...
        <div className="border rounded-xl p-4 shadow-sm space-y-3">
          ...
          <p className="text-sm text-gray-600">{nicknameDescription[language]}</p>
        ...
        <div className="border rounded-xl p-4 shadow-sm space-y-4">
          ...
          <p className="text-sm text-gray-600">{openChatDescription[language]}</p>
