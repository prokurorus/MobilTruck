...
> = {
  ...
  en: {
    ...
    totalLabel: "Total passive income from all 10 levels",
    totalValue: "≈ 15 000 € / month",
  ...
  de: {
    ...
    dynamicHeaders: {
      ...
      income: "Einkommen des Gründers (€/Monat)"
    },
    dynamicRows: [
      { level: "1", companies: "3", percent: "4 %", income: "1 200 €" },
      { level: "2", companies: "5", percent: "2 %", income: "1 000 €" },
    ...
    totalLabel: "Gesamtes passives Einkommen aus allen 10 Ebenen",
    totalValue: "≈ 15 000 € / Monat",
  ...
  es: {
    ...
    dynamicHeaders: {
      ...
      income: "Ingreso del fundador (€/mes)"
    },
    dynamicRows: [
      { level: "1", companies: "3", percent: "4 %", income: "1 200 €" },
      { level: "2", companies: "5", percent: "2 %", income: "1 000 €" },
    ...
    totalLabel: "Ingreso pasivo total de los 10 niveles",
    totalValue: "≈ 15 000 € / mes",
    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto py-10 px-4 space-y-10">
        ...
        <section className="card space-y-4">
          ...
          {/* Итого как в Excel */}
          <div className="border-t border-dashed border-zinc-200 pt-3 flex flex-wrap items-center justify-between gap-2">
